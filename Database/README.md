...
1. [noSQL 과 RDB 의 특징, 차이에 대해 말씀해주세요. 어느 상황에 어떤 데이터베이스를 쓰는게 좋겠습니까?](01.md)
...
15. [(JPA 경험자 한정) JPA 를 이용할 때, JPQL 을 쓰는 경우가 종종 있는데, JPQL 을 쓰시며 좋았던 점과 불편했던 점을 말씀해 주세요.](15.md)
...
21. 정규화에 대해서 설명해주세요.
22. JOIN에 대해서 설명해주세요.
23. [RDBMS vs NOSQL에 대해서 설명해주세요.](01.md)
